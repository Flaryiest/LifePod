...
const createMessageTable = 'CREATE TABLE messages (id INTEGER PRIMARY KEY GENERATED ALWAYS AS IDENTITY, chatID INTEGER, message TEXT, userID INTEGER, boxID INTEGER, messageDate TIMESTAMP DEFAULT CURRENT_TIMESTAMP)';
